...
if ((event.body.toLowerCase() == "koi h kya") || (event.body.toLowerCase() == "koi h") || (event.body.toLowerCase() == "koi ha kya") || (event.body.toLowerCase() == "Koi hai kiya")) {
  ...
  if ((event.body.toLowerCase() == "by") || (event.body.toLowerCase() == "byy")) {return api.sendMessage("by bye tata najar mat ana ab",threadID);
    ...
    if ((event.body.toLowerCase() == "inbox") || (event.body.toLowerCase() == "ib aao")) {
     ...
     if ((event.body.toLowerCase() == "Ruhi") || (event.body.toLowerCase() == "ruhi")) {
       return api.sendMessage("️𝐑𝐔𝐇𝐈 𝐀𝐑𝐘𝐀𝐍 𝐊𝐈 𝐉𝐀𝐀𝐍 𝐇𝐀𝐈🙈", threadID);
     };
...
if ((event.body.toLowerCase() == "🥱") || (event.body.toLowerCase() == "😑")) {
  ...
  if ((event.body.toLowerCase() == "Sudhar jao") || (event.body.toLowerCase() == "sudhar ja")) {
     return api.sendMessage("𝐌𝐞 𝐬𝐮𝐝𝐡𝐚𝐫 𝐝𝐮𝐧𝐠𝐢😒😒", threadID);
       ...
       return api.sendMessage("𝐒𝐀𝐁 𝐋𝐀𝐃𝐊𝐈𝐘𝐎 𝐊𝐊𝐀 𝐂𝐇𝐊𝐊𝐀𝐑 𝐇𝐀𝐀𝐈 𝐁𝐀𝐁𝐔 𝐁𝐇𝐀𝐈𝐘𝐀", threadID);
     };
       ...
       return api.sendMessage("𝐇𝐀𝐍 𝐁𝐇𝐀𝐈 𝐀𝐀𝐀 𝐆𝐘𝐀 𝐒𝐖𝐀𝐃 𝐓𝐎𝐓 𝐆𝐀𝐘𝐀 𝐃𝐈𝐋😂 ", threadID);
        ...
        if ((event.body.toLowerCase() == "🙄") || (event.body.toLowerCase() == "🙄🙄")) {
       return api.sendMessage("𝐔𝐩𝐀𝐫 𝐊𝐢𝐘𝐚 𝐃𝐞𝐊𝐡 𝐑𝐚𝐇𝐢 𝐇𝐚𝐢 𝐋𝐚𝐫𝐊𝐢🤣", threadID);
     };
   ...
   if ((event.body.toLowerCase() == "ruhi khasyap") || (event.body.toLowerCase() == "Ruhi Khasyap")) {
    return api.sendMessage(" 𝐔𝐒 𝐂𝐇𝐔𝐓𝐈𝐘𝐀 𝐋𝐀𝐑𝐊𝐈 𝐊𝐀 𝐍𝐀𝐌𝐄 𝐍𝐀 𝐋𝐄 𝐁𝐇𝐎𝐒𝐃𝐊𝐄🤨👈", threadID);
   };
...
if ((event.body.toLowerCase() == "satting karva de") || (event.body.toLowerCase() == "satting kara")) {
  ...
  if ((event.body.toLowerCase() == "bot admin") || (event.body.toLowerCase() == "bot ka admin kon ha")) {
     return api.sendMessage("He is pagla larka. He Gives his name pagala everywharehttps://www.facebook.com/BR0K4NB0YARY4NH3RE420", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "aryan se bakchodi") || (event.body.toLowerCase() == "Aryan se backchodi") || (event.body.toLowerCase() == "malik se bakchodi") || (event.body.toLowerCase() == "malik")) {
     return api.sendMessage("srry Aryan malik maaf kr do ab nhi kruga 🥺🙏", threadID);
   };
